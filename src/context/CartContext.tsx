...
const CartProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    return (
        <CartContext.Provider value={{ cart, addToCart, removeFromCart, method, setMethod, DELIVERY_COST, anchorElCart, setAnchorElCart, activeStep, handleNext, handleBack, handleReset, handleSkip, isStepOptional, isStepSkipped } as CartContextProps}>
        {children}
